...
def test_independent_tension_source():
    ...
    gnd = Node(circuit, gnd=True)
    n1 = Node(circuit, name="Node1")
    src = IndependentTensionSource(2, gnd, n1, name="Src")
    r1 = Resistor(5, gnd, n1, name="R1")
...
def test_modified_nodal_Independent_current_sources_2nodes():
    ...
    src1 = IndependentCurrentSource(1*(10**-3), gnd, v1, name="S1")
    src2 = IndependentCurrentSource(4*(10**-3), v2, gnd, name="S2")
    
    r1 = Resistor(12*(10**3), gnd, v1, name="R1")
    r2 = Resistor(6*(10**3), v1, v2, name="R2")
    r3 = Resistor(6*(10**3), v2, gnd, name="R3")
...
def test_modified_nodal_Independent_current_sources_4nodes():
    ...
    srcA = IndependentCurrentSource(4*(10**-3), v1, v2, name="SA")
    srcB = IndependentCurrentSource(2*(10**-3), v2, gnd, name="SB")
    
    r1 = Resistor(2*(10**3), v1, v3, name="R1")
    r2 = Resistor(2*(10**3), v1, gnd, name="R2")
    r3 = Resistor(4*(10**3), v2, gnd, name="R3")
    r4 = Resistor(4*(10**3), v2, v3, name="R4")
    r5 = Resistor(1*(10**3), v3, gnd, name="R5")
...
def test_modified_nodal_tension_dependent_current_source():
    ...
    srcA = IndependentCurrentSource(2*(10**-3), v2, v1, name="SA")
    srcB = IndependentCurrentSource(4*(10**-3), gnd, v3, name="SB")
    srcC = TensionDependentCurrentSource(0.002, v2, gnd, v2, v3, name="SC")
    
    r1 = Resistor(1*(10**3), v1, v2, name="R1")
    r2 = Resistor(2*(10**3), v2, v3, name="R2")
    r3 = Resistor(2*(10**3), v1, gnd, name="R3")
    r4 = Resistor(4*(10**3), v3, gnd, name="R4")
...
def test_modified_nodal_current_dependent_tension_source():
    ...
    srcA = IndependentCurrentSource(4*(10**-3), gnd, v2, name="SA")
    
    r1 = Resistor(2*(10**3), v1, gnd, name="R1")
    r2 = Resistor(2*(10**3), v1, v2, name="R2")
    r3 = Resistor(1*(10**3), v2, gnd, name="R3")

    srcB = CurrentDependentTensionSource(2*1000, gnd, v1, r3, v2, name="SB")
...
def test_modified_nodal_tension_dependent_tension_source():
    ...
    v3 = Node(circuit, name="V3")
    v4 = Node(circuit, name="V4")
    v5 = Node(circuit, name="V5")

    srcA = IndependentTensionSource(12, gnd, v2, name="SA")
    srcB = TensionDependentTensionSource(2, gnd, v3, v1, v2, name="SB")
    srcC = IndependentTensionSource(6, v1, v4, name="SC")

    r1 = Resistor(1*(10**3), v1, v2, name="R1")
    r2 = Resistor(1*(10**3), v2, v3, name="R2")
    r3 = Resistor(1*(10**3), v1, v3, name="R3")
    r4 = Resistor(1*(10**3), v3, v4, name="R4")
    r5 = Resistor(1*(10**3), v4, gnd, name="R5")
    r6 = Resistor(1*(10**3), v4, v5, name="R6")
    r7 = Resistor(1*(10**3), v5, gnd, name="R7")

    srcD = CurrentDependentCurrentSource(2, v1, v5, r5, v4, name="SD")
...
def test_modified_nodal_resistance_in_short_circuit():
    ...
    src = IndependentTensionSource(3, gnd, v1, name="S")
    r1 = Resistor(100, v1, v1, name="R1")
    r2 = Resistor(10, v1, gnd, name="R2")
...
def test_modified_nodal_tension_source_in_short_circuit():
    ...
    with pytest.raises(Exception):
        src = IndependentTensionSource(3, gnd, gnd, name="S")

    with pytest.raises(Exception) as e_info:
        src = IndependentTensionSource(3, v1, v1, name="S")
...
def test_modified_nodal_current_source_in_short_circuit():
    ...
    src = IndependentCurrentSource(3, gnd, gnd, name="S")
    r1 = Resistor(6, gnd, v1, name="R")
...
def test_modifed_nodal_resistor_in_open_circuit():
    ...
    src = IndependentTensionSource(1, gnd, v1, name="S")
    r1 = Resistor(2, v1, gnd, name="R1")
    r2 = Resistor(1, v1, v2, name="R2")
...
def test_modified_nodal_current_source_in_open_circuit():
    ...
    src = IndependentCurrentSource(1, gnd, v1, name="S")
